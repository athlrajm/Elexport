...
import './popUniversities2.css'

function PopUniversities2(props) {
  ...
  const pop_uni10 = props.pop_uni10;
  const pop_uni11 = props.pop_uni11;
  const pop_uni12 = props.pop_uni12;
  ...
  const pop_uni_img10 = props.pop_uni_img10;
  const pop_uni_img11 = props.pop_uni_img11;
  const pop_uni_img12 = props.pop_uni_img12;
    ...
    <div className='pop_universities'>
      <h1>Popular Universities</h1>
          <div className='werty'>
            ...
            <div className='pop_uni_images'>
              <div><img src = {pop_uni_img10} alt = {here_we_go_again}/></div>     
              <div className='pop_uni_name10'>{pop_uni10}</div>
            </div> <div className='pop_uni_images'>
              <div><img src = {pop_uni_img11} alt = {here_we_go_again}/></div>     
              <div className='pop_uni_name11'>{pop_uni11}</div>
            </div>
            <div className='pop_uni_images'>
              <div><img src = {pop_uni_img12} alt = {here_we_go_again}/></div>     
              <div className='pop_uni_name12'>{pop_uni12}</div>
            </div>
          </div>
    </div>
  )
...
export default PopUniversities2